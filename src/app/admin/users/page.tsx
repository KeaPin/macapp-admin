            ...
            <div className="flex items-center justify-between border-t border-zinc-700 pt-6">
              <div className="flex flex-1 justify-between sm:hidden">
                <button
                  ...
                  className="relative inline-flex items-center rounded-md border border-zinc-600 bg-zinc-800 px-4 py-2 text-sm font-medium text-zinc-300 hover:bg-zinc-700 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  上一页
                </button>
                <button
                  ...
                  className="relative ml-3 inline-flex items-center rounded-md border border-zinc-600 bg-zinc-800 px-4 py-2 text-sm font-medium text-zinc-300 hover:bg-zinc-700 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  下一页
                </button>
              </div>
              <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                <div>
                  <p className="text-sm text-zinc-400">
                    ...
                    条，共{" "}
                    <span className="font-medium text-white">{pagination.total}</span> 条记录
                  </p>
                </div>
                <div className="flex items-center gap-2">
                  <button
                    onClick={() => setPagination(prev => ({ ...prev, page: Math.max(1, prev.page - 1) }))}
                    disabled={pagination.page <= 1}
                    className="relative inline-flex items-center rounded-md bg-zinc-800 px-3 py-2 text-sm font-semibold text-zinc-300 ring-1 ring-inset ring-zinc-600 hover:bg-zinc-700 focus-visible:outline-offset-0 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    上一页
                  </button>
